$(document).ready(function(){
        ...
        $(".comment-container").delegate(".reply","click",function(){
            ...
            var form = '<form method="post" action="/replies">' +
                ...
                '<div class="form-group"><textarea class="form-control" name="reply" placeholder="Enter your reply" > </textarea> </div> ' +
                '<div class="form-group"> <input class="btn btn-primary" type="submit"> </div>' +
                '</form>';
        ...
        $(".comment-container").delegate(".delete-comment","click",function(){
        	...
        	$.ajax({
                    ...
                    if (response == 1 || response == 2) {
                        ...
                        alert('Oh ! You can only delete your comment');
        ...
        $(".comment-container").delegate(".reply-to-reply","click",function(){
            ...
            var form = '<form method="post" action="/replies">' +
                ...
                '<textarea class="form-control" name="reply" placeholder="Enter your reply" > </textarea> </div> ' +
                '<div class="form-group"> <input class="btn btn-primary" type="submit"> </div></form>';
